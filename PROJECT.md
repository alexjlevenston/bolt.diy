# Project management of codeagent.diy
...
You can find the [epics as issues](https://github.com/stackblitz-labs/codeagent.diy/labels/epic) which are probably never
going to be closed.
