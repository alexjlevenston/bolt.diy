  ...
  return (
    <AnimatePresence>
      ...
      >
        <div
          className={classNames(
            'bg-codeagent-elements-item-backgroundAccent',
            'p-1 rounded-lg text-codeagent-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-codeagent-elements-item-backgroundAccent hover:bg-codeagent-elements-artifacts-backgroundHover"
